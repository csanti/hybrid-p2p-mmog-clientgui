...
namespace clientgui
{
    public abstract class Log
    {
        ...
        private static ConsoleComponent ingameConsole; //ingame console
        private static bool ingameDebug;

        public static void setIngameConsole(ConsoleComponent console)
        {
        ...
        public static void Info(string format, params object[] args)
        {
            ...
            if(ingameDebug)
            {
                ingameConsole.Output.Append(DateTime.Now.ToString("HH:mm:ss.ffffff") + " | " + format);
            }
